public class BankAccountSystem {
    ...
    public void displayAccountDetails() {
        // Using instanceof to check if the object is a BankAccountSystem instance
    ...
    public static void main(String[] args) {
        ...
        BankAccountSystem account1 = new BankAccountSystem("Abhishek", "ACC2465", 1000.00);
        BankAccountSystem account2 = new BankAccountSystem("Subodh", "ACC67800", 1500.00);
