public class EmployeeManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        EmployeeManagementSystem.setCompanyName("Tech Solutions Inc.");

        // Create new employee instances
        EmployeeManagementSystem emp1 = new EmployeeManagementSystem("Subodh", 100, "Software Engineer");
        EmployeeManagementSystem emp2 = new EmployeeManagementSystem("Varun", 101, "Project Manager");
