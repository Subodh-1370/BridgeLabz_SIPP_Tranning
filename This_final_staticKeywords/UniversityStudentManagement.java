public class UniversityStudentManagement {
    ...
    public static void main(String[] args) {
        ...
        UniversityStudentManagement.setUniversityName("GLA University");

        // Create new student instances
        UniversityStudentManagement student1 = new UniversityStudentManagement("Subodh", 131, 'A');
        UniversityStudentManagement student2 = new UniversityStudentManagement("Sharad", 112, 'B');
